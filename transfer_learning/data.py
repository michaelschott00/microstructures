...
class ClassificationDataset(Dataset):
    ...
    def _get_subfolders(self, root_dir: str) -> list[str]:
...
class DataModule(pl.LightningDataModule):
    """Creates the correct datasets and dataloaders with the specified parameters, and
    creates the augmentation and preprocessing pipeline.
    ...
    def get_train_augmentations(self) -> A.Compose:
        ...
        if self.hparams["crop_ratio"]:
            ...
            train_transform.append(
                A.RandomSizedCrop(
                    min_max_height=(
                        int(min_edge * self.hparams["crop_ratio"]),
                        min_edge,
                    ),
    ...
    def setup(self, stage: str) -> None:
        """Sets up the datasets for the individual stages."""
